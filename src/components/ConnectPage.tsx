...
export function ConnectPage() {
  const params = useParams({ strict: false }) as { peerId?: string };
  ...
  const handleConnect = async () => {
    ...
    try {
      // Add contact with peer ID as provisional name (will be updated by ping)
      await addContact({
        id: peerId,
      ...
      // Try to connect and ping to get their real name
