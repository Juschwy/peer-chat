...
export const PeerMessageSchema = z.discriminatedUnion('type', [
  ...
  z.object({
    type: z.literal('MESSAGE_RETURN_RECEIVED'),
    content: MessageReturnReceivedContentSchema,
  }),
  z.object({ type: z.literal('MESSAGE_RETURN_READ'), content: MessageReturnReadContentSchema }),
  z.object({
    type: z.literal('MESSAGE_RETURN_INVALID'),
    content: MessageReturnInvalidContentSchema,
  }),
